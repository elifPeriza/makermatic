...
export default function Header() {
  ...
  const handleColorPaletteGeneration = async () => {
    ...
    if (responseWithDelay.error) {
      setError(responseWithDelay.error);
      return;
    }
            ...
            <div className="w-[90vw] max-w-[700px] rounded-md bg-midblue p-6 sm:p-10">
              <div className="flex flex-col font-sans text-base text-white ">
                ...
                <textarea
                  ...
                  className="mb-4 h-20 min-h-[32px] rounded-md border border-lightblue bg-darkblue p-2"
                ></textarea>
                <div className="mt-4 flex flex-col gap-6">
                  ...
                  {isLoading ? (
                    <p className="self-center text-brightgreen">
                      Generating ...
                    </p>
                  ) : (
